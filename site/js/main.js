(function () {
  ...
  const FEATURES = [
    ...
    },
    {
      ...
      text: "Связка аккаунтов через /link: один пользователь — одна память и история во всех каналах.",
    },
    {
      icon: "🔐",
    ...
    {
      icon: "🧠",
      title: "Персональная память",
      text: "Отдельный workspace на пользователя, консолидация контекста и /clear_memory с архивом.",
    },
    {
      icon: "🎙️",
