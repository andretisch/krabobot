...
class TestHandleStop:
    ...
    async def test_stop_no_active_task(self):
        ...
        from krabobot.command.builtin import cmd_stop
        ...
        assert "Нет активных задач" in out.content
    ...
    async def test_stop_cancels_active_task(self):
        ...
        assert "остановлено задач" in out.content.lower()
    ...
    async def test_stop_cancels_multiple_tasks(self):
        ...
        assert "Остановлено задач: 2" in out.content
...
class TestSubagentCancellation:
    ...
    async def test_subagent_preserves_reasoning_fields_in_tool_turn(self, monkeypatch, tmp_path):
        from krabobot.agent.subagent import SubagentManager
        from krabobot.bus.queue import MessageBus
        from krabobot.providers.base import LLMResponse, ToolCallRequest
        ...
        monkeypatch.setattr("krabobot.agent.tools.registry.ToolRegistry.execute", fake_execute)
