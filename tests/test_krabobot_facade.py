...
def test_from_config_default_path():
    ...
    with patch("krabobot.config.loader.load_config") as mock_load, \
         patch("krabobot.krabobot._make_provider") as mock_prov:
...
def test_import_from_top_level():
    from krabobot import Nanobot as N, RunResult as R
    assert N is Nanobot
