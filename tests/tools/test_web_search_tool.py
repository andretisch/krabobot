...
from krabobot.agent.tools.web import WebSearchTool
...
async def test_duckduckgo_search(monkeypatch):
    ...
    monkeypatch.setattr("krabobot.agent.tools.web.DDGS", MockDDGS, raising=False)
    import krabobot.agent.tools.web as web_mod
