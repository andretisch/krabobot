...
from krabobot.agent.tools.mcp import MCPToolWrapper, connect_mcp_servers
from krabobot.agent.tools.registry import ToolRegistry
from krabobot.config.schema import MCPServerConfig
...
async def test_connect_mcp_servers_enabled_tools_warns_on_unknown_entries(
    ...
    monkeypatch.setattr("krabobot.agent.tools.mcp.logger.warning", _warning)
