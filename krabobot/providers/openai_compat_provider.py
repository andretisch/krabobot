...
if TYPE_CHECKING:
    from krabobot.providers.registry import ProviderSpec
...
_DEFAULT_OPENROUTER_HEADERS = {
    "HTTP-Referer": "https://github.com/HKUDS/krabobot",
    "X-OpenRouter-Title": "krabobot",
...
class OpenAICompatProvider(LLMProvider):
    ...
    @staticmethod
    def _should_retry_with_max_completion_tokens(e: Exception) -> bool:
        text = OpenAICompatProvider._error_text(e).lower()
        return "max_tokens" in text and "max_completion_tokens" in text

    @staticmethod
    def _with_max_completion_tokens(kwargs: dict[str, Any]) -> dict[str, Any]:
    ...
    async def chat(
        ...
        try:
            ...
            if self._should_retry_with_max_completion_tokens(e):
                try:
                    retry_kwargs = self._with_max_completion_tokens(kwargs)
