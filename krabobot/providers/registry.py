...
class ProviderSpec:
    ...
    display_name: str = ""  # shown in `krabobot status`
...
PROVIDERS: tuple[ProviderSpec, ...] = (
    ...
    ProviderSpec(
        ...
        display_name="ProxyAPI",
        backend="openai_compat",
        is_gateway=True,
        detect_by_base_keyword="proxyapi.ru",
        default_api_base="https://api.proxyapi.ru/openai/v1",
    ),
    ProviderSpec(
        name="gptunnel",
        keywords=("gptunnel",),
        env_key="GPTUNNEL_API_KEY",
        display_name="GPTunneL",
        backend="openai_compat",
        is_gateway=True,
        detect_by_base_keyword="gptunnel.ru",
        default_api_base="https://gptunnel.ru/v1",
    ),
    ProviderSpec(
        name="ollama",
