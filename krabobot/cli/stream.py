...
class ThinkingSpinner:
    """Spinner that shows 'krabobot is thinking...' with pause support."""

    def __init__(self, console: Console | None = None):
        c = console or _make_console()
        self._spinner = c.status("[dim]krabobot is thinking...[/dim]", spinner="dots")
        self._active = False
