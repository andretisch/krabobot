...
class ChannelsConfig(Base):
    ...
    Channel configs are stored as extra fields (dicts).
...
class ProvidersConfig(Base):
    ...
    proxyapi: ProviderConfig = Field(default_factory=ProviderConfig)
    gptunnel: ProviderConfig = Field(default_factory=ProviderConfig)
...
class Config(BaseSettings):
    ...
    def _match_provider(
        ...
        from krabobot.providers.registry import PROVIDERS, find_by_name
